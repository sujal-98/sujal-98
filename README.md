...
I'm a passionate **Full-Stack Developer**, **Automation Engineer**, and **Tech Explorer** who loves building scalable web applications, automating testing pipelines, and experimenting with infrastructure and AI.

- 🌱 Currently working on **Video Streaming**, **Real Estate Platforms**, **Real-Time Dashboards**, and a **Banking Platform**.  
- 💼 Professionally working as a **QA Automation Engineer**, specializing in **Appium**, **Selenium**, **Cucumber**, **TestNG**, **JMeter**, and **LoadRunner**.  
- 🧠 Learning and exploring **Infrastructure Automation** (Terraform, Ansible, Jenkins, AWS) and diving into **AI & ML** for intelligent system design.  
- 💬 Ask me about **Frontend Development**, **Backend Development**, **DevOps**, **Cloud Technologies**, or **Automation Testing**.  
...
![JMeter](https://img.shields.io/badge/-JMeter-05122A?style=flat&logo=apache-jmeter)&nbsp;
![LoadRunner](https://img.shields.io/badge/-LoadRunner-05122A?style=flat&logo=micro-focus)&nbsp;

### ☁️ DevOps & Infra Automation
...
A modern banking platform for managing accounts, transactions, and more. Developed using Next.js, Plaid, Dwolla, Appwrite, ShadCN, and Chart.js.
